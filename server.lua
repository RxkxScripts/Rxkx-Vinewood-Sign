...
LoadFramework = function()
    ...
    print('[rxkxvinewoodsign] Framework found: ' .. FrameworkFound)
end
...
RegisterCommand(Config.Command, function(source, args, rawCommand)
    ...
    TriggerClientEvent('rxkxvinewoodsign:openNui', source, GetFileData()[1], GetFileData()[2])
end)

RegisterServerEvent('rxkxvinewoodsign:saveText')
AddEventHandler('rxkxvinewoodsign:saveText', function(data)
...
AddEventHandler('rxkxvinewoodsign:loadText', function()
    TriggerClientEvent('rxkxvinewoodsign:saveText', source, GetFileData())
end)
