...
Citizen.CreateThread(function()
    LoadFramework()
    TriggerServerEvent('rxkxvinewoodsign:loadText')
end)

RegisterNetEvent('rxkxvinewoodsign:openNui')
AddEventHandler('rxkxvinewoodsign:openNui', function(text, color)
    nuiOpen = true
...
RegisterNUICallback('saveText', function(data)
    TriggerServerEvent('rxkxvinewoodsign:saveText', data)
end)
...
RegisterNetEvent('rxkxvinewoodsign:saveText')
